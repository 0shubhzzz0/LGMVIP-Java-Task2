...
public class TicTacToe extends JPanel{
    ...
    static JLabel information=new JLabel("<html>------------------|| LetsGrowMore ||------------------ <br/>Welcome at 2 Player Tic Tac Toe Game.<br/>X will play first.<br/> Click near the center of a slot to place X in:");
